...
class Wasm3Function {
 public:
  ...
  Wasm3Function(JSValueRefs func, Wasm3Runtime* runtime);
 ...
 private:
  Wasm3Runtime* runtime_;

  IM3Function m3_function_;
  JSValueRefs js_function_;

  [[maybe_unused]] Wasm3Instance* instance_ = nullptr;
};
