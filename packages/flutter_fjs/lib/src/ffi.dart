...
typedef _SetToastC =
    ffi.Void Function(FJSVMHandle, ffi.Pointer<ffi.NativeFunction<OnToastC>>);
typedef _SetToastD =
    void Function(FJSVMHandle, ffi.Pointer<ffi.NativeFunction<OnToastC>>);

typedef _EvalSourceC =
    ffi.Int32 Function(
      FJSVMHandle,
      ffi.Pointer<ffi.Uint8>,
      ffi.Int32,
...
typedef _DispatchEventD =
    int Function(FJSVMHandle, int, int, ffi.Pointer<ffi.Uint8>, int);
...
typedef _HeapD =
    void Function(FJSVMHandle, ffi.Pointer<ffi.Int64>, ffi.Pointer<ffi.Int64>);
...
typedef _HandlePutBytesD =
    int Function(FJSVMHandle, int, ffi.Pointer<ffi.Uint8>, int);
typedef _HandleBytesC =
    ffi.Void Function(
      FJSVMHandle,
      ffi.Int64,
...
class FjsBindings {
  FjsBindings._(this.lib)
    : vmCreate = lib.lookupFunction<_VmCreateC, _VmCreateD>('fjs_vm_create'),
      vmDestroy = lib.lookupFunction<_VmDestroyC, _VmDestroyD>(
        'fjs_vm_destroy',
      ),
      setCallbacks = lib.lookupFunction<_SetCallbacksC, _SetCallbacksD>(
        'fjs_set_callbacks',
      ),
      setToast = lib.lookupFunction<_SetToastC, _SetToastD>(
        'fjs_set_toast_callback',
      ),
      evalSource = lib.lookupFunction<_EvalSourceC, _EvalSourceD>(
        'fjs_vm_eval_source',
      ),
      evalBundle = lib.lookupFunction<_EvalBundleC, _EvalBundleD>(
        'fjs_vm_eval_bundle',
      ),
      ...
      lastError = lib.lookupFunction<_LastErrorC, _LastErrorD>(
        'fjs_last_error',
      ),
